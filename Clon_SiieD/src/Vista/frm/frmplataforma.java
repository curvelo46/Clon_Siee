...
public class frmplataforma extends javax.swing.JFrame {
    ...
    public frmplataforma(Base_De_Datos basedato, String Cargo, String usuario) {
        ...
        btnReinicio = new JButton("Reinicio académico");
        btnReinicio.setFont(new java.awt.Font("Segoe UI", 1, 14));
        btnReinicio.setForeground(Color.BLACK);
        btnReinicio.setBackground(new Color(250,217,124));
        btnReinicio.setMaximumSize(new Dimension(190, 60));
        btnReinicio.setPreferredSize(new Dimension(190, 60));
        btnReinicio.setMinimumSize(new Dimension(190, 60));
        btnReinicio.setAlignmentX(JPanel.LEFT_ALIGNMENT);
    ...
    private void lbReporteAAMouseClicked(java.awt.event.MouseEvent evt) {                                         
        ...
        jtPestañas.setSelectedComponent(scroll);
    }                                        
