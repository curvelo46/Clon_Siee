...
insert  into Alumnos values(1,'Andres','camilo','curvelo','diaz','18','3243582032','andrescurvelodiaz@gmail.com','calle29 el resto no','1084451641');
insert  into Alumnos values(2,'jose','billero','granado','martines','20','3945768123','','la livertador','4900224');
insert  into Alumnos values(3,'hilary','fontalvo','ospina','ospina','18','12321323','andrescamilo@gmail.com','11000232','4234');
insert  into Alumnos values(4,'andrea','martines','curvelo','jose','10','1232323','andrescamilo@gmail.com','11000232','434');
insert  into Alumnos values(5,'milagro','la doña','peleona',' de la esquina','70','1232323','andrescamilo@gmail.com','11000232','4');
...
BEGIN
    ...
    INSERT INTO net (nombre, corte, nota) VALUES (NEW.nombre, 1, 0.0);
