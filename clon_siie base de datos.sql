...
SELECT nombre,materia FROM materias WHERE materia IS NULL OR materia = '';
...
create table materias(nombre varchar(125), materia varchar(125) );
...
insert into materias values ('jose','');
insert into materias values ('marcin','');
